...
// updated by a single push. In the optimal case you will have all
...
unsigned dshotVersion = 600;  // can be one of 150, 300, 600, 1200, ... and can be reassigned before init.
